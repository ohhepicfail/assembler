...
DEF_CMD(CALL , 19, 3, {stack_push (fcalls, cur + 1); cur = commands[cur] - 1;})
DEF_CMD(RET  , 20, 0, {cur = stack_pop (fcalls);})
DEF_CMD(LABEL, 21, 4, {printf ("\nHELLO, I'M LABEL AND WHAT I'M DOING HERE?\n");})
DEF_CMD(END  , 22, 0, {cur = sz; printf ("\nEND");})
DEF_CMD(STD  , 23, 0, {stack_dump (stk, NAME (stk));})
